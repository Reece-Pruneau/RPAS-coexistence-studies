...
d_sep=38000; % (m) seperation distance between both networks
...
CLp=max_dBmUE-P_0-10*log10(round((0.95*bw)./180e3));
...
indoor(s,n,i)=1;
I_dBmUEb(s,n,i)=SINR_target+noisefloor-AntGain_b_b(s,n,i)-L_b_b(s,n,i)-UE_gain-L_feeder-L_body-L_entry;
end
